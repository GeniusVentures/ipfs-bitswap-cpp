...
namespace
{
    ...
    bool RequestBlock( std::shared_ptr<sgns::ipfs_bitswap::Bitswap>       bitswap,
...
int main( int argc, const char *argv[] )
{
    ...
    // Hello world
    auto cid = libp2p::multi::ContentIdentifierCodec::fromString( "QmWATWQ7fVPP2EFGu71UkfnqhYXDYH566qy47CnJDgvs8u" )
                   .value();
