...
{
    BitswapMessage::BitswapMessage( bitswap_pb::Message &pb_msg ) : pb_msg_( pb_msg ) {}
    ...
    void BitswapMessage::AddBlockPresence( const libp2p::multi::ContentIdentifier &cid, bool have )
    {
        ...
        presence->set_type( have ? bitswap_pb::Message_BlockPresenceType_Have
                                 : bitswap_pb::Message_BlockPresenceType_DontHave );
    }
